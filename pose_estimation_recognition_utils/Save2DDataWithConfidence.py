...
class Save2DDataWithConfidence(Save2DData):
    """
    Deprecated: Use Save2DData with confidence parameter instead.
    """
    ...
    def __init__(self, idx: int, x: float, y: float, confidence: float):
        ...
        """
        warnings.warn("Save2DDataWithConfidence is deprecated. Use Save2DData instead.", DeprecationWarning, stacklevel=2)
        super().__init__(idx=idx, x=x, y=y, confidence=confidence)